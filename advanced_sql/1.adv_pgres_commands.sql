-- Let us create a job_applied table to track all jobs we applied to
...
-- Change the contac_name data type from VARCHAR(50) to Text that can hold unlimited characters
ALTER TABLE job_applied     
